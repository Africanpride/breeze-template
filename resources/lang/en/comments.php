...
return [
    ...
    'index_route_description' => 'Retrieve existing comments.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the comment property name where the value is the assigned value to the retrieved comment.',
    ...
    'show_route_description' => 'Retrieve existsing comment.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the comment to retrieve',
    'destroy_route_description' => 'Delete existsing comment.',
    ...
    'the_id_of_model_to_delete' => 'The id of the comment to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete comments.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the comment.',
    ...
    'the_requested_model_does_not_exists' => 'The requested comment does not exists.',
    ...
    'edit' => 'Edit Comment',
    'show' => 'Show Comment',
    'show_all' => 'Show All Comment',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Comment.',
    'none_available' => 'No Comments Available.',
    'model_plural' => 'Comments',
    'model_was_added' => 'Comment was successfully added.',
    'model_was_retrieved' => 'Comment was successfully retrieved.',
    'models_were_retrieved' => 'Comments were successfully retrieved.',
    'model_was_updated' => 'Comment was successfully updated.',
    'model_was_deleted' => 'Comment was successfully deleted.',
