...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <dl class="dl-horizontal">
            ...
            <dt>{{ trans('articles.user_id') }}</dt>
            <dd>{{ optional($article->user)->name }}</dd>
            <dt>{{ trans('articles.category_id') }}</dt>
            <dd>{{ optional($article->category)->id }}</dd>
            <dt>{{ trans('articles.comment_id') }}</dt>
            <dd>{{ optional($article->comment)->id }}</dd>
